export const recipes = {
    recipe1: {
        ...
        ingredients: [
            ...
            {
                quantity: '.5 teaspoon',
                name: 'black pepper, plus more to taste',
            },
            {
                quantity: '.5 teaspoon',
                name: 'baking soda',
    ...
    recipe2: {
        ...
        ingredients: [
            ...
            {
                quantity: '1 cup',
                name: 'whole wheat breadcrumbs, preferably coarse-ground',
            },
        ],
        instructions: [
    ...
    recipe3: {
        ...
        ingredients: [
            {
                quantity: '2 medium',
                name: 'fennel bulbs, trimmed, some fronds reserved',
            },
            {
                quantity: '3',
